...
//
	...
	processPathEdit: function (pathEditJson) {
            if (pathEditJson.SubOperation === "recreate") {
                ...
                var newMuscle = new SkinnedMuscle(newGeometry, this.materials[pathSpec.material], pointArray, activeArray);
	    ...
	    var newMuscle = new SkinnedMuscle(newGeometry, pathMaterial, pathEditJson.points);
	    newMuscle.uuid = pathEditJson.uuid;
	    this.cache[newMuscle.uuid] = newMuscle;
	    // add to parent.
