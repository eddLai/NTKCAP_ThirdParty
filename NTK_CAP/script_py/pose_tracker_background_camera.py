...
def parse_args():
    ...
    parser.add_argument(
        'pose_model',
        help='path of mmdeploy SDK model dumped by model converter')
    parser.add_argument('video', help='video folder')
    parser.add_argument('--output_dir', help='output directory', default=None)
    parser.add_argument(
        '--skeleton',
        default='halpe26',
        choices=['coco', 'coco_wholebody', 'halpe26'],
...
def visualize(frame,
    ...
    cv2.putText(frame, 'people: '+ str(len(keypoints)), (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 1)
    cv2.imshow('camera', frame)
    
    
    if cv2.waitKey(1) == ord('q'):
        return False
    elif cv2.getWindowProperty('camera', cv2.WND_PROP_VISIBLE) < 1:
        return False
    else:
        return True
...
def main():
    ...
    while True:
        ...
        if not visualize(frame, results, frame_id, skeleton_type=args.skeleton):
            break
